...
interface SidebarProps {
  onPageChange: (page: 'chat' | 'alerts' | 'saved' | 'settings' | 'pro') => void;
  currentPage: string;
  onProClick: () => void;
}

const Sidebar: React.FC<SidebarProps> = ({ onPageChange, currentPage, onProClick }) => {
      ...
      <div className="p-4 flex-1 overflow-hidden flex flex-col">
        ...
        <div className="space-y-1 mb-4">
          ...
          >
            ...
            <span className={`${currentPage === 'settings' ? 'text-fuchsia-700' : 'text-gray-700'}`}>
              Settings
            </span>
          </button>
        </div>
